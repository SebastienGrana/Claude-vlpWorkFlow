...
Un kit portable, à copier tel quel dans n'importe quel projet. Il apporte trois
commandes, sept gabarits de fichiers, et la convention qui les tient ensemble.
...
commands/
  ...
  vlp-init.md              /vlp-init — équiper un projet en six questions
templates/
  ...
  context AI/
    methode-chantier.md    la méthode, à poser dans le projet
...
INSTALLATION.md            la mise en place, en trois copies
```
