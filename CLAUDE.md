...
| jouer une fiche du chantier ESD (les essais d'un chantier sans découpe, puis republier) | `context AI/62-essais-sans-decoupe.md` — chantier **ouvert**, par `/vlp:tache ESD<n>` |
