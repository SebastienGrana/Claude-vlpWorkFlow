...
| jouer une fiche du chantier MTK (mesure-tokens.py se lit et se borne en ligne de commande) | `context AI/48-mesure-plage.md` — chantier **ouvert**, par `/vlp:tache MTK<n>` |
