...
| `69-bac-essai.md` | on relit le socle du chantier BAC — **clos** « Un bac d'essai par script », `BAC1..BAC2` |
...
| `72-sans-tampon.md` | on joue une fiche `SON*` — chantier **ouvert** « Rejouer un hook à la main sans le tampon », `SON1..SON1` |
