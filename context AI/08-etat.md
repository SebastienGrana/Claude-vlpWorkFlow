...
| 71 | `TOU` — Le filet n'avertit qu'une fois par tour | Vu en `RAT1` (2026-09-26) : 13 avertissements dans un même tour (`PostToolUseFailure:Read`, plafond 5) — le filet parle après chaque appel groupé, du texte en double dans le contexte du sous-agent. Un avertissement par tour ; essai à plafond 5 (≈ 0,15 $). | ~0,5 fiche | — |
